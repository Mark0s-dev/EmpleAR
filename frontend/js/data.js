...
/**
 * Jerarquía Argentina → Provincia → Ciudad.
 * Un solo lugar para esta data: evita repetir provincias y
 * ciudades sueltas en distintos <select> del HTML.
 */
const LOCATIONS = {
 ...
 * @property {string} schedule     - "manana" | "tarde" | "noche" | "rotativo"
